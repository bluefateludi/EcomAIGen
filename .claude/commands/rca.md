---
description: Analyze and document root cause for a bug or issue
...
Investigate the issue: "$ARGUMENTS" in this repository, identify the root cause, and document findings for future implementation.

**About this issue:**
Please provide a brief description of the problem you're experiencing, including:
...
- A clear description of the bug or issue to investigate
...
Check recent changes to affected areas. Use git log to see recent modifications:
```bash
...
Save analysis as: `docs/rca/issue-{timestamp}-{short-title}.md`
...
[Clear description of the issue based on user input]
...
2. Run: `/implement-fix [issue-description]` to implement the fix
